   ...
   */
	Hooks.on("ready", async () => {
		...
		CONFIG.ChatMessage.documentClass.prototype.getTest = function () {
			if (hasProperty(this, "flags.testData")) { return game.wfrp4e.rolls.TestWFRP.recreate(this.flags.testData); }
		};
		CONFIG.ChatMessage.documentClass.prototype.getOppose = function () {
			if (hasProperty(this, "flags.wfrp4e.opposeData")) { return new OpposedWFRP(getProperty(this, "flags.wfrp4e.opposeData")); }
		};

		CONFIG.ChatMessage.documentClass.prototype.getOpposedTest = function () {
			if (hasProperty(this, "flags.wfrp4e.opposeTestData")) { return OpposedTest.recreate(getProperty(this, "flags.wfrp4e.opposeTestData")); }
		};
      ...
      && game.settings.get("wfrp4e", "autoFillAdvantage", true)) {
		...
		for (let e of game.wfrp4e.postReadyPrepare) { e.prepareData(); }
